...
void PictureWindowPrivate::onCut() {
    ...
    TClipboard::setText(_clipboardText.text);
    checkpoint();
    onClear();
}
...
void PictureWindowPrivate::onPaste(const std::string& text) {
    ClipboardText ct{};
    ct.text = text;
    ...
    if (event.what == evKeyDown) {
        ...
        switch (event.message.command) {
            ...
            case cmPaste:
                ...
                // This *asynchronously* kicks off a paste.
