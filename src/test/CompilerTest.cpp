...
COMPILER_TEST(ContainsKey_doc_1)
COMPILER_TEST(ContainsKey_map_number_to_number_1)
COMPILER_TEST(ContainsKey_map_number_to_number_2)
COMPILER_TEST(ContainsKey_map_number_to_number_3)
COMPILER_TEST(ContainsKey_map_string_to_number_1)
COMPILER_TEST(ContainsKey_map_string_to_number_2)
COMPILER_TEST(ContainsKey_map_string_to_number_3)
COMPILER_TEST(Contains_set_number)
COMPILER_TEST(Contains_set_string)
...
COMPILER_TEST(Find_map_number_to_number_1)
COMPILER_TEST(Find_map_number_to_number_2)
COMPILER_TEST(Find_map_number_to_string_1)
COMPILER_TEST(Find_map_number_to_string_2)
COMPILER_TEST(Find_map_string_to_number_1)
COMPILER_TEST(Find_map_string_to_number_2)
COMPILER_TEST(Find_map_string_to_string_1)
COMPILER_TEST(Find_map_string_to_string_2)
...
COMPILER_TEST(ParseNumber_1)
COMPILER_TEST(ParseNumber_2)
COMPILER_TEST(ParseNumber_3)
...
COMPILER_TEST(Replace_1)
COMPILER_TEST(Replace_2)
COMPILER_TEST(Seconds)
COMPILER_TEST(Set_number_empty)
COMPILER_TEST(Set_number_minus_operator)
COMPILER_TEST(Set_number_plus_operator_1)
COMPILER_TEST(Set_number_plus_operator_2)
COMPILER_TEST(Set_string_empty)
COMPILER_TEST(Set_string_minus_operator)
COMPILER_TEST(Set_string_plus_operator_1)
COMPILER_TEST(Set_string_plus_operator_2)
...
COMPILER_TEST(Split_1)
COMPILER_TEST(Split_2)
...
COMPILER_TEST(Values_set_1)
COMPILER_TEST(Values_set_2)
COMPILER_TEST(advent_of_code_2023_day1)
COMPILER_TEST(advent_of_code_2023_day2)
COMPILER_TEST(advent_of_code_2023_day3_part1)
COMPILER_TEST(advent_of_code_2023_day3_part2)
COMPILER_TEST(advent_of_code_2023_day4_part1)
COMPILER_TEST(and_or_short_circuit)
COMPILER_TEST(anonymous_to_named_record_conversion_inside_for)
COMPILER_TEST(anonymous_to_named_record_conversion_inside_foreach)
COMPILER_TEST(anonymous_to_named_record_conversion_inside_if)
COMPILER_TEST(anonymous_to_named_record_conversion_inside_while)
COMPILER_TEST(anonymous_to_named_record_conversion_outside_block)
...
COMPILER_TEST(dim_list_with_yield_map)
COMPILER_TEST(dim_map_with_yield_list)
COMPILER_TEST(dim_set_duplicate_number)
COMPILER_TEST(dim_set_duplicate_string)
...
COMPILER_TEST(function_with_no_parameters_1)
COMPILER_TEST(function_with_no_parameters_2)
...
COMPILER_TEST(list_of_list_of_number)
...
COMPILER_TEST(return_named_record_1)
COMPILER_TEST(return_named_record_2)
COMPILER_TEST(return_named_record_explicitly_converted_to_optional)
COMPILER_TEST(return_named_record_implicitly_converted_to_optional)
COMPILER_TEST(return_nothing_in_function)
COMPILER_TEST(return_value_in_subroutine)
...
COMPILER_TEST(variable_shadowing_function)
COMPILER_TEST(variable_string)
COMPILER_TEST(while_continue)
COMPILER_TEST(while_exit)
COMPILER_TEST(while_loop)
COMPILER_TEST(wrong_return_type)
COMPILER_TEST(yield_number_and_print)
COMPILER_TEST(yield_outside_dim_list)
