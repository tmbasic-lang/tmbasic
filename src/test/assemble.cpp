...
static SystemCall parseSystemCall(string s) {
    ...
    */
    static const std::unordered_map<string, SystemCall> map = {
        ...
        { "Chr", SystemCall::kChr },
        { "CounterIsPastLimit", SystemCall::kCounterIsPastLimit },
        ...
        { "DateToString", SystemCall::kDateToString },
        { "DateTimeToString", SystemCall::kDateTimeToString },
        { "DateTimeOffsetToString", SystemCall::kDateTimeOffsetToString },
        ...
        { "StringLen", SystemCall::kStringLen },
        ...
        { "TimeZoneToString", SystemCall::kTimeZoneToString },
